...
fn item_to_preferences(item: &Value) -> Preferences {
    Preferences {
        ...
        category_file_buttons: attr_bool(item, "category_file_buttons").unwrap_or(false),
...
fn preferences_to_item(telegram_user_id: i64, preferences: &Preferences) -> Value {
    json!({
        ...
        "category_file_buttons": {"BOOL": preferences.category_file_buttons},
...
mod tests {
    ...
    fn round_trips_preferences_through_dynamodb_json() {
        ...
        assert!(parsed.category_file_buttons);
    ...
    fn old_preferences_default_to_new_enabled_flags() {
        ...
        assert!(!preferences.category_file_buttons);
    ...
    fn malformed_dynamodb_attributes_fall_back_safely() {
        let item = json!({
            ...
            "category_file_buttons": {"BOOL": true},
